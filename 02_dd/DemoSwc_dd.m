%% DemoSwc_dd 数据字典V2（由dd_excel2m自动生成，勿手改，去改xlsx的Input/Output/Calibration）
%% 生成时间: 2026-09-05 22:26:32
DD = struct(); DD.SWCName = 'DemoSwc';
DD.Input = {
...
DD.Runnable = {
  ...
  'R_DemoSwc_10ms', '10', 'TimingEvent', 'P_VehSpd;P_DrvMode;P_DrvTrqReq', 'main runnable'
};
DD.Signal = {
  'Name', 'Kind', 'DataType', 'Init', 'Desc';
