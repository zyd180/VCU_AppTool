%% BattIf_dd 数据字典V2（由dd_excel2m自动生成，勿手改，去改xlsx的Input/Output/Calibration）
%% 生成时间: 2026-09-06 00:28:02
DD = struct(); DD.SWCName = 'BattIf';
DD.Input = {
...
DD.Runnable = {
  ...
  'R_BattIf_10ms', '10', 'TimingEvent', 'P_VehSpd;P_DrvMode;P_DrvTrqReq', 'main runnable'
};
DD.Signal = {
  'Name', 'Kind', 'DataType', 'Init', 'Desc', 'SrcBlock';
  'Irv_TrqLim', 'IRV', 'DrvTrqReq', '0', 'internal torque limit', '';
  'Meas_TrqOut', 'Meas', 'DrvTrqReq', '0', 'measurement for cal', 'Cal_TrqMax'
};
